...
class RecentWindowRecall {
     ...
     * 可用命中不能指回自己，也不能落回当前组。
     */
    private boolean isUsableMatch(@NonNull MemoryArchiveDocument rootArchive,
                                  String currentGroupId,
     ...
     */
    private String buildQuery(@NonNull MemoryArchiveDocument archive) {
        return RecentWindowSupport.normalize(archive.getKeywordSummary());
    }
}
