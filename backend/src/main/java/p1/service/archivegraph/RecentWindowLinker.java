...
import p1.service.ArchiveLinkService;
...
public class RecentWindowLinker {
    ...
    public void linkRoot(String sessionId,
        ...
        log.info("[recent-window][结果] sessionId={} rootArchiveId={} winnerArchiveId={} winnerGroupId={} bestScore={} vectorSupportScore={} boostedSupportScore={} sharedTagCount={} sharedTags={} hitCount={} candidateCount={} usableMatchCount={}",
                sessionId,
                rootArchive.getId(),
                target.targetArchiveId(),
                target.groupId(),
        ...
        log.info("[recent-window][打分] sessionId={} rootArchiveId={} winnerArchiveId={} winnerGroupId={} timeDecayFactor={} candidateAgeHours={} timeAdjustedSupportScore={} normalizedIdfScore={} boostedSupportScore={}",
                sessionId,
                rootArchive.getId(),
                target.targetArchiveId(),
                target.groupId(),
