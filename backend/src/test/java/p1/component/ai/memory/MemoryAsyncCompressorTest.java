...
class MemoryAsyncCompressorTest {
    ...
    void shouldWriteOnlyImportantEventsAndPersistFinalTags() {
        ...
        ExtractedMemoryEventDTO mergedEvent = new ExtractedMemoryEventDTO();
        ...
        @SuppressWarnings("unchecked")
        ArgumentCaptor<List<ExtractedMemoryEventDTO>> eventCaptor = ArgumentCaptor.forClass(List.class);
        @SuppressWarnings("unchecked")
        ...
        List<ExtractedMemoryEventDTO> savedEvents = eventCaptor.getValue();
