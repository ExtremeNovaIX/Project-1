...
public interface GamerAgent {
    ...
    @SystemMessage("""
            ...
            4. 每批操作前简要说明策略，operations 可以包含多条操作；桥接层会在底层逐条执行。
            ...
            [
              {"tool":"combat_play_card","args":{"card_index":0,"target":"NIBBIT_0"},"note":"先打出收益最高的攻击牌"},
              {"tool":"combat_end_turn","args":{},"note":"没有更多有效操作，结束当前行动窗口"}
            ]
            </response_format>
