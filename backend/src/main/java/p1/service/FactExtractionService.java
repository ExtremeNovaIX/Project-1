...
public class FactExtractionService {
    ...
    private List<ExtractedMemoryEventDTO> mergePipelineEvents(List<ExtractedFactEventDTO> extractedEvents,
        ...
        List<ExtractedMemoryEventDTO> merged = new ArrayList<>();
        for (int i = 0; i < safeExtractedEvents.size(); i++) {
            ...
            ExtractedMemoryEventDTO dto = new ExtractedMemoryEventDTO();
