...
record AnchorCandidate(Long archiveId,
    ...
    List<String> matchedTags(List<String> tags) {
        ...
        for (String tag : tags) {
            String normalizedTag = tag == null ? "" : tag.trim().toLowerCase(java.util.Locale.ROOT);
...
record RankContext(java.util.Set<String> currentGroupTags,
                   java.util.Map<String, java.util.Set<String>> tagsByGroupId,
                   java.util.Map<String, Integer> documentFrequency,
                   int taggedGroupCount,
                   java.util.Map<String, LocalDateTime> createdAtByGroupId,
